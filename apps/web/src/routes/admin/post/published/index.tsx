              ...
              <div className="divide-y divide-border/40">
                {publishedPosts.map((post, idx) => {
                  ...
                  return (
                    <div
                      key={post.id}
                      className="p-6 hover:bg-background/30 transition-colors duration-200 flex items-start justify-between group relative animate-slide-in-up"
                    ...
                    >
                      ...
                      <div className="ml-4 flex gap-2 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        <button
                          onClick={() =>
                            navigate({ to: `/admin/post/${post.id}` })
                          }
