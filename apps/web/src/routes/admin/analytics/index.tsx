      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat, idx) => {
          ...
          return (
            <div
              key={stat.label}
              className={`rounded-lg border border-border/40 bg-linear-to-br ${stat.color} animate-slide-in-up p-6 transition-all duration-300 hover:scale-105 hover:border-primary/30 hover:shadow-lg`}
